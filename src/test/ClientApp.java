...
public class ClientApp {
	...
	public static void main(String[] args) {
       ...
       // perform persistence operations
		//System.out.println(service.registerEmp(1001,"ramesh","clerk",900));
		...
		//System.out.println("All Emp Details are"+service.getAllEmpDetails(7499));
		System.out.println("Fire Emp"+service.fireEmp(1001));
